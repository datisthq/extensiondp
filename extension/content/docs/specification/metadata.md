...
- <a id="definitions/Package"></a>**`Package`** *(object)*
  - <a id="definitions/Package/properties/%24schema"></a>**`$schema`**: Must be: `"https://raw.githubusercontent.com/datisthq/extensiondp/v0.1.4/extension/profile.json"`.
...
- <a id="definitions/Table1Resource"></a>**`Table1Resource`** *(object)*: Data records have to conform to the Table1 schema.
  ...
  - <a id="definitions/Table1Resource/properties/schema"></a>**`schema`**: Must be: `"https://raw.githubusercontent.com/datisthq/extensiondp/v0.1.4/extension/schemas/table1.json"`.
- <a id="definitions/Table2Resource"></a>**`Table2Resource`** *(object)*: Data items have to conform to the Table2 schema.
  ...
  - <a id="definitions/Table2Resource/properties/schema"></a>**`schema`**: Must be: `"https://raw.githubusercontent.com/datisthq/extensiondp/v0.1.4/extension/schemas/table2.json"`.
