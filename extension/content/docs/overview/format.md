...
> [!TIP]
> This is a template to create your own Data Package Extension. To start using it, click "Use this template" on [GitHub](https://github.com/datisthq/extensiondp) in the top right corner. After cloning a newly created repo, run `git tag 0.1.0 && git push --tags` to create an initial version. Read [Contribution Guide](contributing) for following steps. **This documentation is just a placeholder to get started with!**
